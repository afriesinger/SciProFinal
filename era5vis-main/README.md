...
To download a single snapshot of weather data (Temperature, Wind, and Geopotential) for a specific area in the Alps, use example: 

```bash
era5vis_download -o my_data.nc -s 2025-01-14-12 -a 47.5 10.5 46.5 11.5. 
...
- **Vertical Cross-Section:** Shows atmospheric structure and non-dimensional mountain height
  
  ![Vertical Cross-Section](./assets/example_plot.png)
